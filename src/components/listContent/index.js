  ...
  return (
    <div className={styles.listContent} id="use-cases">
      ...
      <Container size="large">
        <h3>
          <span>BrandStak</span> Lifestyle &amp; retail use cases
        </h3>
        <div className={styles.listContentInner}>
          <div ref={contentBlockListRef} className={styles.listContentLeft}>
            {[
              {
                content:
                  "Identify demand for products across all consumer touch points",
                image: Image1,
              },
              {
                content:
                  "Maximize demand servicing for consumers with lower levels of inventory",
                image: Image2,
              },
              {
                content:
                  "Understand, map and influence brand consumer journeys throughout the site",
                image: Image3,
              },
              {
                content:
                  "Drive footfall, increase clicks and engender loyalty through social media",
                image: Image4,
              },
              {
                content:
                  "Maximize operating leverage through a better-quality store estate",
                image: Image5,
              },
              {
                content:
                  "Identify the “value add” each store delivers to sales across all channels",
                image: Image5,
              },
            ].map((contentItem, contentItemIndex) => {
              const contentBlockStyles = [
                styles.listContentBlock,
                contentItemIndex === activeListItem
                  ? styles["active"]
                  : styles["inactive"],
              ];
              return (
